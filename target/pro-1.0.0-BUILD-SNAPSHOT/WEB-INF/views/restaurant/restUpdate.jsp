	...
	<div class="section-top-border">
		<div class="row">
			<div class="col-lg-8 col-md-8" id="write-div">
				<h3 class="mb-30 title_color">Restaurant Update</h3>
				<form action="./restUpdate" method="post" id="frm" enctype="multipart/form-data">
					<input type="hidden" id="rest_num" name="rest_num" value="${vo.rest_num}">
					<div class="mt-10">
						<input type="text" id="rest_name" name="rest_name" value="${vo.rest_name}" placeholder="식당 이름"
					...
					<div class="mt-10">
						<textarea id="rest_contents" name="rest_contents" placeholder="식당 소개글"
							...
							onfocus="this.placeholder = ''"
							onblur="this.placeholder = '식당 소개글'" required class="single-input" >${vo.rest_contents}</textarea>
					</div>
					<!-- 주소 API -->
					<div class="mt-10">
						<input type="text" id="rest_post1" name="rest_post1" placeholder="우편번호" readonly="readonly" 	onfocus="this.placeholder = ''"
							required class="single-input" required class="single-input" value="${vo.rest_post1}" >
						<input type="button" onclick="daum_execDaumPostcode()" value="우편번호 찾기"><br>
						<input type="text" id="rest_addr1" name="rest_addr1" placeholder="주소" readonly="readonly" required class="single-input" value="${vo.rest_addr1}" ><br>
						<input type="text" class="rest" id="rest_addr2" name="rest_addr2" placeholder="상세주소" value="${vo.rest_addr2}" >
					...
					<div class="mt-10">
						<input type="text" id="rest_tel" name="rest_tel" placeholder="식당 전화번호"
							...
							class="single-input" value="${vo.rest_tel}" >
					</div>
					<div class="mt-10">
						<input type="text" class="rest" id="rest_url" name="rest_url" placeholder="식당 홈페이지 주소" value="${vo.rest_url}" >
					</div>
