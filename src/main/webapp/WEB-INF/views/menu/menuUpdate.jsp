		...
		<c:forEach items="${vo.files}" var = "file">
			...
			<div id = "menu_view_detail">
				<div id = "myAssignZone">
					...
					<p class = "t1">
					<input type="text" placeholder="${vo.price}" class = "menuUpdate_input" name="price" id="price"
					>
						<%-- ${vo.price} 원 --%>
						<br>
					</p>
				...
				<div class="product_view_info">
					...
					<input type="text" placeholder="${vo.menu_contents}" class = "menuUpdate_input" name="menu_contents" id="menu_contents"
					>
						<%-- ${vo.menu_contents} --%>
					</div>
					<div class = "product_factor">
						<p><input type="text" placeholder="${vo.origin}" class = "menuUpdate_input" name="origin" id="origin"
					></p>
				...
				<button class="genric-btn info">확인</button>
